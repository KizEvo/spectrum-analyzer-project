...
enum RCC_APB1_CLK_POS	{TIM2, TIM3, TIM4, TIM5, TIM6, TIM7, TIM12, TIM13, TIM14, WWDGEN = 11, SPI2EN = 14, SPI3EN, USART2EN = 17, USART3EN, UART4EN,
							UART5EN, I2C1EN, I2C2EN, I2C3EN, CAN1EN = 25, CAN2EN, PWREN = 28, DACEN, UART7EN, UART8EN};
